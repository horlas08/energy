...
const navigationConfig: NavigationTree[] = [
    ...
    {
        key: 'energy.business',
        path: '/energy/business',
        title: 'Business',
        translateKey: 'nav.business.title',
        icon: 'business',
        type: NAV_ITEM_TYPE_ITEM,
        authority: [],
        subMenu: [],
    ...
    // {
    //     key: 'energy.business',
    //     path: '/energy/business/details/:walletId',
    //     title: 'Business',
    //     translateKey: 'nav.business.details',
    //     icon: 'business',
