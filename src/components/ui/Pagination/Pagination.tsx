...
const Pagination = (props: PaginationProps) => {
    ...
    const pagerClass = {
        ...
        active: `!rounded-[50%] text-${themeColor}-${primaryColorLevel} bg-success-badge_bg hover:bg-${themeColor}-50 dark:bg-${themeColor}-${primaryColorLevel} dark:text-gray-100`,
    ...
    return (
        <div className={` w-full py-5 px-8 flex justify-between ${paginationClass}`}>
